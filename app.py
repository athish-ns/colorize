...
def colorizer(img):
    ...
    prototxt = r"models_colorization_deploy_v2.prototxt"
...
st.write("One of the most advanced learning project that colorizes a black and white image.")
st.write("Created by Athish")
